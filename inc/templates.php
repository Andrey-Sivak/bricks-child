 ...
 */
function bricks_child_include_template( $template_name, $args = array(), $return = false ) {
    $template_path = BRICKS_CHILD_DIR . '/' . $template_name;
 ...
 */
function bricks_child_cpt_post_class( $classes, $class, $post_id ) {
 ...
 */
function bricks_child_get_field( $field_name, $post_id = 0, $default = '' ) {
    if ( ! $post_id ) {
        $post_id = get_the_ID();
    }
 ...
 * @return void
 */
function bricks_child_the_field( $field_name, $post_id = 0, $default = '' ) {
    echo esc_html( bricks_child_get_field( $field_name, $post_id, $default ) );
}
